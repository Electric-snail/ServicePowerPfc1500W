...
{\
	...
	{PFC_PWM_CHANNEL, 			DC_SEL_TRIPIN5,     	DC_SEL_TRIPIN4,       	DC_SEL_NONE,		DC_SEL_NONE,			DCxHH_LI,		  DCxEVT1_OUT_FORCE,			DCxHI_LH,		      DCxEVT2_OUT_FORCE,			EVT_DISABLE,	  DCxEVT1_OUT_NONE,			EVT_DISABLE,	  DCxEVT2_OUT_NONE},\
}
